...
// Convenience wrapper
func Main() {
	// Easier option is use github.com/spf13/pflag, but doing this for learning.
	...
	lineMode := flag.Bool("lines", false, "Count lines.")
	byteMode := flag.Bool("bytes", false, "Count bytes.")
