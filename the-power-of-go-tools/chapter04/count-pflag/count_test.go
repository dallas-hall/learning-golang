...
// Copied from TestLineCounter_SuccessfullyCountsLinesFromStdin. See that test for details.
func TestWordCounter_SuccessfullyCountsWordsFromStdin(t *testing.T) {
	t.Parallel()

	inputBuffer := bytes.NewBufferString("I see you\nbaby\nshaking dat ass")
