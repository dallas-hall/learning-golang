...
/*
Interfaces are named collections of method signatures. They Interfaces define a contract - a set of method signatures that a type must implement. You don't declare that you implement them!
...
// circle now implements geometry automatically!
...
i.e. It is a polymorphic function, it accepts ANY type that implements geometry
*/
...
When to use:
* Type assertion: When checking for one specific type
* Type switch: When checking for multiple possible types
*/
func detectCircle(g geometry) {
	if c, ok := g.(circle); ok { // Type assertion
